...
<section className="bg-white dark:bg-gray-900">
    <div className="container px-6 py-12 mx-auto">
        <div>
            <p className="font-medium text-blue-500 dark:text-blue-400 text-xl">Contact us</p>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">vaibhav.cryptosleep@gmail.com</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Mon-Sun from 8am to 8pm.</p>
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 73517 39555</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">FF-11, Wave Galleria,Wave City, Ghaziabad, Uttar Pradesh, India</p>
                </div>
            ...
            <div className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                    <div className="mx-2 md:items-center md:flex">
                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            ...
                            <input ref={firstname} type="text" placeholder="John " className="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>

                        <div className="flex-1 px-2 mt-4 md:mt-0">
                            <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Last Name</label>
                            <input ref={lastname} type="text" placeholder="Doe" className="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
                    </div>

                    <div className="mt-4">
                        <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Mobile Number</label>
                        <input ref={number} type="number" placeholder="+91 9988776655" className="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>

                    <div className="w-full mt-4">
                        <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Message</label>
                        <textarea ref={message} className="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                    </div>
          ...
          <div className="px-3 text-center text-white">
            ...
            <div className=" md:flex md:justify-center">
              <div className="flex justify-between  md:gap-8 font-serif">
                <p className="md:text-xl ">Mattress</p>
                <p className="md:text-xl ">About Us</p>
                <p className="md:text-xl ">Curtains</p>
              </div>
            </div>
            ...
            <div className='flex my-3 justify-between'>
                <img src="../icons/facebook-svgrepo-com.svg" alt="" className='w-8 ms-4 mx-3'/>
                <img src="../icons/instagram-svgrepo-com.svg" alt="" className='w-8 mx-3'/>
                <img src="../icons/linkedin-svgrepo-com.svg" alt="" className='w-8 mx-3'/>
              </div>
            </div>
          </div>
